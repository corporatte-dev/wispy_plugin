...
function updateAvatar(avatar, goal)
	while avatar do 
		...
		avatar.PrimaryPart.CFrame = CFrame.new(avatar.PrimaryPart.Position, Vector3.new(goal.Position.X, avatar.PrimaryPart.Position.Y, avatar.PrimaryPart.Position.Z))
